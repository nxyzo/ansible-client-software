...
Ansible Role Wrapper for Winscp Install and Uninstall (PSADT v4) from Jason Berger
...
To obtain the WinSCP installer, download the latest .exe or .msi file from the official WinSCP website (https://winscp.net/eng/download.php). Place the installer in the directory C:\Temp\WinSCP\Files\. If you require the .msi version, select “Other Downloads” on the download page to access it. The deployment process will locate and execute the installer from this path during installation.
